...
2. **درگاه پرداخت بانک سامان (SEP)** - [**وبسایت**](https://www.sep.ir/) | [**مستندات**](docs/providers-documents/saman-3.3.pdf)
3. **درگاه پرداخت زرین پال** - [**وبسایت**](https://www.zarinpal.com/) | [**مستندات**](https://www.zarinpal.com/docs/paymentGateway/)
4. **درگاه پرداخت زیبال** - [**وبسایت**](https://zibal.ir/) | [**مستندات**](https://help.zibal.ir/IPG/API/)
5. **درگاه پرداخت باهمتا** - [**وبسایت**](https://bahamta.com/) | [**مستندات**](https://webpay.bahamta.com/doc/api)
6. **درگاه به پرداخت** - [**وبسایت**](https://www.behpardakht.ir/index.html) | [**مستندات**](docs/providers-documents/mellat-1.29.pdf)
7. **درگاه ایران درگاه** - [**وبسایت**](https://irandargah.com/) | [**مستندات**](https://docs.irandargah.com/)
8. **درگاه آسان پرداخت** - [**وبسایت**](https://asanpardakht.ir/) | [**مستندات**](docs/providers-documents/asanpardakht-3.6.pdf)
...
12. `SAMPLE_RESULT_NAMESPACE`: اگر میخواهید صفحه نمونه داخلی را اورراید کنید یا پروژه دارای اپ های مختلفی است وقسمت پرداخت در اپ جداگانه ای قرار دارد می‌توانید محل قرار گیری یو آر ال های پیشفرض را تغییر دهید برای مثال:
    ...
    ```
13. `IS_SAFE_GET_GATEWAY_PAYMENT`:<br>
   ```
